...
public class AnnouncementRepository {
    ...
    //Hash Map που αποθηκεύει τις ανακοινώσεις κάθε Τμήματος
    private static final Map<String, List<AnnouncementView>> departmentAnnouncements = new HashMap<>();
     
    static 
    {
        // Αρχικοποίηση με προκαθορισμένες ανακοινώσεις 
    ...
    //Επιστροφή της λίστας ανακοινώσεων για ένα συγκεκριμένο Τμήμα
    ...
    //Προσθήκη νέας ανακοίνωσης στο συγκεκριμένο Τμήμα
    ...
    //Επιστρέφει όλα τα ονόματα των Τμημάτων που έχουν ανακοινώσεις
